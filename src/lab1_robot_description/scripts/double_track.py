...
class DoubleTrackNode(Node):
    def __init__(self):
        ...
        self.odom_publisher1 = self.create_publisher(Odometry, "/double_track/odom", 10)
    ...
    def timer_callback(self):
        ...
        new_odom[5] = (self.vel_rear[0] - self.vel_rear[1])/self.track_width #devide by distnce between 2 wheel
        self.odom = new_odom
